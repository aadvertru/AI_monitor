...
from libs.execution.post_processing import (  # noqa: E402
    AuditPostProcessingSummary,
    process_audit_results,
)

PostProcessingService = Callable[[AsyncSession, int], Awaitable[AuditPostProcessingSummary]]


def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Process stored raw audit responses into parsed results and scores."
    )
...
async def run_cli(
    ...
    *,
    service: PostProcessingService = process_audit_results,
) -> int:
